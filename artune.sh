...
if [[ -d "$SCRIPT_DIR/modules" ]]; then
    ...
    MODULES_DIR="/usr/share/artune/modules"
    CONFIG_DIR="/usr/share/artune/config"
fi
...
echo ""
echo -e "  Verify anytime with:   ${CYAN}sudo artune --verify${NC}"
echo -e "  Roll back everything:  ${CYAN}sudo artune --rollback${NC}"